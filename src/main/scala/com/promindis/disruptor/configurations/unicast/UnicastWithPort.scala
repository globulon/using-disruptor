...
import com.promindis.disruptor.port.BatchEventProcessor

object UnicastWithPort extends Scenario{
  ...
  override def challenge(implicit config: Configuration) = {
    ...
    val processor = BatchEventProcessor[ValueEvent](rb, barrier, handler);
